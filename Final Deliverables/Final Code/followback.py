...
def fetch_cartarr(userid):
    arr=[]
    query = "select  o.prodname,o.price,p.pic1,c.size,o.category,o.type,o.prodid,o.offer,c.ouantity from outfit o inner join picture p on o.prodid=p.prodid INNER join cart c on c.prodid=p.prodid where userid='"+userid+"' ORDER BY c.dateoadded DESC"
